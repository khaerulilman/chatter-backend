import { userUseCases, postUseCases } from "../../container.js";

const { getUsersService, getUserByUsernameService, updateProfileService } =
  userUseCases;
const { getPostsByUserIdService } = postUseCases;
